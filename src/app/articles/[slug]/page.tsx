...
import { apiEndpoint } from "@/constants/server-constants";
...
const Article = async ({ params: { slug } }: { params: { slug: string } }) => {
  ...
  return (
    <article className="mx-auto max-w-3xl py-10 format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
