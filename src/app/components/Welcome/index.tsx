        ...
        <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400 lg:col-span-6 px-10 lg:px-0 lg:pr-4 lg:max-w-md xl:max-w-lg 2xl:max-w-2xl">
          ...
          <div className="mb-4">
            ...
            <p className="text-lg leading-relaxed">
              ...
              it&apos;s a transformational experience that can change your life.
              Travel is a pilgrimage that can help you discover new
            ...
            <p className="text-lg leading-relaxed">
              ...
              fields but also passionate about creating unique and personalized
              experiences for each of our clients.
            </p>
          </div>
        </div>
      </div>
