...
const ProductCard = ({ image, name, text, alt }: ProductCardProps) => {
  return (
    <div className="mx-auto flex-none snap-center snap-always group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-lg hover:shadow-black/30">
