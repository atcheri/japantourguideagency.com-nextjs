      ...
      <div className="container mx-auto px-3">
        <div className="flex items-center h-screen">
          <div className="flex flex-col max-w-xl gap-5 z-[2] text-white">
            ...
            <h2 className="text-xl text-slate-100 font-semibold md:text-2xl md:max-w-sm">
              {message}
            </h2>
            <Link href={STORE_ROUTES.STORE.path}>
              <button className="font-semibold py-2 px-4 border rounded-md transition ease-in-out hover:scale-105 hover:text-white hover:border-transparent">
                Discover now
              </button>
            </Link>
          </div>
