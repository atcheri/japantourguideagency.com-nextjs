      ...
      <NavigationMenuList className="md:gap-x-2 lg:gap-x-4">
        ...
        {navBarMenu.map((menu) => (
          <NavigationMenuItem key={menu.menuTitle}>
            <NavigationMenuTrigger>{menu.menuTitle}</NavigationMenuTrigger>
            <NavigationMenuContent>
        ...
        {/*TODO: see how to integrate optionnaly an image in ListItem as props and row-span-3 like in the example */}
