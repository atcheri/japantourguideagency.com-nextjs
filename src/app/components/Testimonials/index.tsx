...
const feedbacks: FeedbackType[] = [
  {
    ...
    name: "Allison",
    stars: 5,
    content: `I really cannot express enough how fantastic our experience was.
          </br>Masae and Tak were extraordinary and really were key factors in bringing this bucket list adventure into reality for us. 
          </br>Let me start by saying that we were not very aware of what Japan's weather is like and for that reason we initially booked this private adventure to go and see Mt. Fuji.
          </br>Masae communicated with us prior to our arrival that the likelihood of catching a glimpse of the shy mountain was not very good for our dates.
          </br>Instead, she gave us several other suggestions and left the day open to whatever adventure suited the best for our desires and the weather the day of our trip.
          </br>Tak was early to pick us up and we were all so excited that we were off earlier than expected. 
          </br>Because our first stop was meant to be the Digital Art Exhibit and it was not due to open yet, she added a quick stop at "Baby Liberty" (a miniature of our statue of Liberty, also gifted by the french) along with an additional stop in Odaiba, at a massive statue of one of Japan's Anime favorites, Gundam (19.7 meters).
          </br>Then on to the museum. It was INCREDIBLE. Such a cool experience for our entire group (8 people from 7 to 43 years old).
          </br>Lots of different rooms with different themes and interactive experiences.
          </br>Next: Kamakura. Such a beautiful little city. Masae was spot on in this suggestion for us. We saw the great buddha, had lunch, visited Tsurugaoka Hachimangū and wandered through some of the cute streets and shops along the way.
          </br>Lunch note: We had several people in our group on the hunt for great Ramen. Masae and Tak discussed and came up with a great stop for us at a little ramen shop for lunch. They sat and talked with us and really made the experience better for us with their company.
          </br>Tak helped me decode my puzzle box that I purchased on our way to see the great Buddha. Mmmm. I am still dreaming of that ramen.
          </br>The drive to and from: Delightfßul. Such a comfortable van for all eight of us. Masae was eager to share any info along the way or answer any questions. They were very accommodating to our needs, stopping for us to grab some snacks and drinks too.
          </br>I really have only super positive memories and anecdotes from this experience. It was truly a delight spending the day with Masae and Tak both and our whole group would highly reccomend this trip!
        `,
